...
#ifdef FORCE_CUSTOM_UPDATER_FINGERPRINT
extern bool link_custom_updater(ZipWrap *Zip, const char *updater_path);
#endif
...
#ifdef FORCE_CUSTOM_UPDATER_FINGERPRINT
	if (!link_custom_updater(Zip, TMP_UPDATER_BINARY_PATH))
#endif

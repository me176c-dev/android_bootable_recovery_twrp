...
ifneq ($(TW_FORCE_CUSTOM_UPDATER_FINGERPRINT),)
    LOCAL_SRC_FILES += force_custom_updater.cpp
    LOCAL_CFLAGS += \
        -DFORCE_CUSTOM_UPDATER=\"$(TW_FORCE_CUSTOM_UPDATER)\" \
        -DFORCE_CUSTOM_UPDATER_FINGERPRINT=\"$(TW_FORCE_CUSTOM_UPDATER_FINGERPRINT)\"
    LOCAL_REQUIRED_MODULES += $(TW_FORCE_CUSTOM_UPDATER)
endif
